    ...
    <header class="bg-white py-4 shadow z-50 relative">
        <div class="w-full max-w-7xl px-4 md:px-6 mx-auto flex items-center justify-between">
            ...
            <nav class="hidden lg:block">
                <ul class="flex space-x-8">
                    ...
                    <li>
                        <a href="/pickup"
                            class="{{ request()->is('pickup') ? 'font-bold text-primary' : 'hover:text-primary transition' }}">PickUp</a>
                    </li>
                </ul>
            </nav>
        ...
        <div id="mobile-menu"
            ...
            <nav class="flex flex-col px-6 py-4 space-y-4">
                ...
                <a href="/pickup"
                    class="{{ request()->is('pickup') ? 'font-bold text-primary' : 'text-gray-700 hover:text-primary transition' }}">
                    Pickup
                </a>

...
<body>
    ...
    <header class="bg-white py-4 shadow z-50 relative">
        <div class="w-full max-w-7xl px-4 md:px-6 mx-auto flex items-center justify-between">
            ...
            <nav class="hidden lg:block">
                <ul class="flex space-x-8">
                    ...
                    <li><a href="#" class="hover:text-primary transition">Artikel</a></li>
        ...
        <div id="mobile-menu"
            ...
            <nav class="flex flex-col px-6 py-4 space-y-4">
                <a href="#" class="font-bold text-primary border-b border-gray-100 pb-2">Home</a>
                ...
                <a href="#" class="text-gray-700 hover:text-primary border-b border-gray-100 pb-2">Tentang
                    Kami</a>
                <a href="#" class="text-gray-700 hover:text-primary border-b border-gray-100 pb-2">Artikel</a>
            ...
            <form class="grid grid-cols-1 md:grid-cols-2 gap-6 md:gap-8 text-white mt-8 md:mt-12">
                ...
                <div class="space-y-2 col-span-1 md:col-span-2">
                    ...
                    <textarea name="" id="" cols="30" rows="4"
                        placeholder="Kecamatan + Detail alamat lengkap"
    ...
    <footer class="bg-primary py-10 px-6">
        <div class="w-full max-w-7xl mx-auto text-center text-white grid md:grid-cols-4 gap-10">
            <div class="md:col-span-2 space-y-8 text-start">
